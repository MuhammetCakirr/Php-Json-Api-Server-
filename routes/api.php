...
/*Genre Operations*/
Route::middleware('auth:sanctum')->prefix('Genre')->group(function () {
    Route::middleware(LogUnauthorizedAccess::class)->group(function () {
...
Route::prefix('User')->group(function () {
    Route::middleware(LogUnauthorizedAccess::class)->group(function () {
        ...
        Route::middleware('auth:sanctum')->get('AllUsers', [UserController::class, 'index']);
        Route::middleware('auth:sanctum')->post('ShowUserById/{id}', [UserController::class, 'show']);
        Route::middleware('auth:sanctum')->put('UpdateUser/{id}', [UserController::class, 'update']);
        Route::middleware('auth:sanctum')->post('DeleteUser/{id}', [UserController::class, 'delete']);
    });
});
...
Route::middleware('auth:sanctum')->prefix('BookUser')->group(function () {
    Route::middleware(LogUnauthorizedAccess::class)->group(function () {
...
route::middleware('auth:sanctum')->prefix('RolePermission')->group(function () {
    Route::middleware(LogUnauthorizedAccess::class)->group(function () {
